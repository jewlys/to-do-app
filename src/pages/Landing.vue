...
<template>
    <div class="sticky top-0 flex items-center flex-shrink-0 w-full h-16 px-10 bg-white bg-opacity-75">
        <img src="../assets/images/Group 12.png" style="height: 32px; " alt="">
        <p class="mx-2 text-sm font-semibold text-gray-600 hover:text-indigo-700">Potion</p>
        <!-- 
        ...
        <div class="ml-10">
            <a class="mx-2 text-sm font-semibold text-indigo-700" href="#">Pricing</a>
                ...
                <div class="w-full md:w-1/2 md:px-3">
                    <div
                        ...
                        <h1
                            ...
                            <span class="block text-indigo-600 xl:inline">and ready to switch?</span>
                        </h1>
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">We're the potion
                            for all problems you have with Notion.</p>
    ...
    <footer class="p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/"
                class="hover:underline">Potion™</a>. All Rights Reserved.
        </span>
