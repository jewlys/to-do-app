  ...
  >
    ...
    >
      <div class="text-sm lg:flex-grow">
        <a
          href="#aboutUs"
          class="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-blue-400 mr-4"
        >
          About Us
        </a>
        ...
        <a
          href="#clients"
          class="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-blue-400"
        >
          Clients
        </a>
      </div>
      ...
      <div>
        <a
          href="/login"
          class="inline-block text-sm px-4 py-2 leading-none text-white border-white hover:border-transparent hover:text-blue-400 hover:bg-white mt-4 lg:mt-0"
          >Log In</a
        >
      </div>
    </div>
        ...
        <div class="w-full md:w-1/2 md:px-3">
          ...
          >
            ...
            >
              ...
              <span class="block text-blue-300 xl:inline"
