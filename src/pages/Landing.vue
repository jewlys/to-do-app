        ...
        <div class="w-full md:w-1/2 md:px-3">
          <div
            ...
            <h1
              ...
              <span class="block text-indigo-500 xl:inline">and ready to switch?</span>
            </h1>
            ...
            <div class="relative flex flex-col sm:flex-row sm:space-x-4">
              <a href="/signup"
                class="flex items-center w-full px-6 py-3 mb-3 text-lg text-slate-900 bg-indigo-300 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
                Sign Up
      ...
      <div id="section1" class="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
        ...
        <ul class="p-0 m-0 leading-6 border-0 border-gray-300">
          <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
            <span
              class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-indigo-400 rounded-full"><span
