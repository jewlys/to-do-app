...
<template>
  <!-- Section 1.1-->
  <nav class="flex items-center justify-between flex-wrap sticky bg-pink-300 p-6">
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div class="text-sm lg:flex-grow">
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-pink-500 mr-4">
        Feature
      </a>
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-pink-400 mr-4">
        Pricing
      </a>
    ...
    <div>
      <a href="#" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-pink-400 hover:bg-white mt-4 lg:mt-0">Sign Up</a>
      <a href="#" class="inline-block text-sm px-4 py-2 leading-none  text-white border-white hover:border-transparent hover:text-pink-400 hover:bg-white mt-4 lg:mt-0">Log In</a>
    </div>
  </div>
</nav>
  <!-- Section 2 -->
        ...
        <div class="w-full md:w-1/2 md:px-3">
          <div
            ...
            <h1
              ...
              <span class="block text-pink-300 xl:inline">and ready to switch?</span>
            </h1>
            <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
              We're the potion for all problems you have with Notion.
            </p>
  ...
  <section class="w-full bg-white pt-7 pb-7 md:pt-20 md:pb-24">
    <div
      ...
      <!-- Content -->
      <div id="section1" class="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
        ...
        <ul class="p-0 m-0 leading-6 border-0 border-gray-300">
          <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
            <span
              class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-pink-400 rounded-full"><span
                class="text-sm font-bold">✓</span></span>
        ...
        <div class="items-center justify-center w-full mt-12 mb-4 lg:flex">
          <div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
            <div class="flex items-center justify-center">
              ...
              <div class="flex flex-col items-start justify-center">
                <h4 class="font-bold text-gray-800">Joan Cifo</h4>
                <p class="text-gray-600">CEO of Potion (the Big Boss)</p>
              </div>
            </div>
          ...
          <div class="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
            <div class="flex items-center justify-center">
              ...
              <div class="flex flex-col items-start justify-center">
                <h4 class="font-bold text-gray-800">Luis Rodriguez</h4>
                <p class="text-gray-600">Chief of S.O.S</p>
              </div>
            </div>
            <blockquote class="mt-8 text-lg text-gray-500">
  ...
  <footer class="p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022
      <a href="https://flowbite.com/" class="hover:underline">Potion™</a>. All
      Rights Reserved.
    </span>
