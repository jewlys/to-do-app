...
<template>
  <section class="relative py-20 2xl:py-40 overflow-hidden to-pink-200 via-indigo-200 from-blue-200 bg-gradient-to-tr">
    <div class="relative container px-4 mx-auto">
      <div class="max-w-5xl mx-auto">
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
            <div class="max-w-md">
              <span class="text-lg text-slate-700 font-bold">Register Account</span>
            ...
            <div class="px-6 lg:px-20 py-12 lg:py-24 bg-indigo-300 rounded-lg">
              <form @submit.prevent="sendForm()" action="#">
                ...
                <div class="flex items-center pl-6 mb-6 bg-white rounded-full">
                  ...
                  <input class="w-full pl-4 pr-6 py-4 font-bold placeholder-slate-700 rounded-r-full focus:outline-none"
