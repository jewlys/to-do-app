            ...
            <div class="relative w-auto my-6 mx-auto max-w-6xl">
                ...
                <div
                    ...
                    <div class="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                        <button
                            class="text-rose-300 bg-transparent border border-solid border-rose-500 hover:bg-rose-300 hover:text-white active:bg-rose-600 font-bold uppercase text-sm px-6 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                            type="button" v-on:click="toggleModal()">
                            Close
                        </button>
                        <button
                            class="text-indigo-500 hover:bg-indigo-200 active:bg-gray-500   font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
